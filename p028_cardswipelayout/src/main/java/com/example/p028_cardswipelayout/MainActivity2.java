...
//                Toast.makeText(MainActivity.this, "第" + ratings.getText_content() + "详情Long", Toast.LENGTH_SHORT).show();
            ...
            public void onItemClick(RecyclerView.ViewHolder viewHolder, int position) {
                Toast.makeText(MainActivity2.this, "第" + position + "详情", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        cardCallback.setOnSwipedListener(new OnSwipeListener<Integer>() {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, Integer o, int direction) {
                ...
                myHolder.dislikeImageView.setAlpha(0f);
                myHolder.likeImageView.setAlpha(0f);
                Toast.makeText(MainActivity2.this, direction == CardConfig.SWIPED_LEFT ? "swiped left" : "swiped right", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onSwipedClear() {
                Toast.makeText(MainActivity2.this, "data clear", Toast.LENGTH_SHORT).show();
