...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link com.example.p011_swipebacklayout.geekshining.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.example.p011_swipebacklayout.geekshining.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
