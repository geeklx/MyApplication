...
public class ToastUtil {
    ...
    public static void showToastShort(String toastText) {
        if (toast == null) {
            toast = Toast.makeText(DemoUppictureApplication.get(), "", Toast.LENGTH_SHORT);
    ...
    public static void showToastLong(String toastText) {
        if (toast == null) {
            toast = Toast.makeText(DemoUppictureApplication.get(), "", Toast.LENGTH_LONG);
            updToastTextSize(toast);
        }
        toast.setGravity(Gravity.CENTER, 0, 0);
        toast.setText(toastText + "");
    ...
    public static void showToastShort(int res) {
        showToastShort(DemoUppictureApplication.get().getString(res));
    }

    public static void showToastLong(int res) {
        showToastLong(DemoUppictureApplication.get().getString(res));
    }
