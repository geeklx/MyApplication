...
public class CountDownViewDown extends View {
    //圆轮颜色
...
//    };
    ...
    private float startAngle_scroll = 92;//起始滚动点bufen2
    ...
    public CountDownViewDown(Context context) {
        this(context, null);
    }

    public CountDownViewDown(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountDownViewDown(Context context, AttributeSet attrs, int defStyleAttr) {
