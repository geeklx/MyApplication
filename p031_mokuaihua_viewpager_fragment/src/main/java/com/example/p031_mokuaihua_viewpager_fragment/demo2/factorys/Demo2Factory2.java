...
//        IndexConfig.DEFAULT_PAGE_INDEX = 1;
    ...
    private static void registerFragments(SparseArrayCompat<Class<? extends BaseFragment>> sIndexFragments) {
        sIndexFragments.put(R.id.demo2_page_0_item_1, Demo2Fragment2.class);//菜谱
        sIndexFragments.put(R.id.demo2_page_0_item_2, Demo2Fragment1.class);//视频
    }
}
