...
public class ToastUtil {
    ...
    public static void showToastShort(String toastText) {
        ...
        if (toast == null) {
            toast = Toast.makeText(FridgeApplication.get(), "", Toast.LENGTH_SHORT);
    ...
    public static void showToastShort(int res) {
        showToastShort(FridgeApplication.get().getString(res));
    }

    public static void showToastLong(int res) {
        showToastLong(FridgeApplication.get().getString(res));
    }
