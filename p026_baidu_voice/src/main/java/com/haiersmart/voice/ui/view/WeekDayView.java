package com.haiersmart.voice.ui.view;
...
public class WeekDayView extends View {
    //上横线颜色
    private int mTopLineColor = Color.parseColor("#ffffffff");
    //下横线颜色
    private int mBottomLineColor = Color.parseColor("#ffffffff");
    //周一到周五的颜色
    private int mWeedayColor = Color.parseColor("#ffffff");
    //周六、周日的颜色
    private int mWeekendColor = Color.parseColor("#ffffff");
    //线的宽度
    private int mStrokeWidth = 0;
    private int mWeekSize = 31;
    private Paint paint;
