...
import com.haiersmart.voice.utils.DateUtils;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int day = 0;day < mMonthDays;day++){
            ...
            if(dayString.equals(mSelDay+"")){
                ...
                canvas.drawCircle((startRecX+endRecX)/2, (startRecY+endRecY)/2, (endRecY-startRecY)/2, mPaint);
                //记录第几行，即第几周
                weekRow = row + 1;
            }
            //绘制事务圆形标志
