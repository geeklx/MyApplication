...
public class CountDownViewAll extends View {
    //圆轮颜色
...
//            Color.parseColor("#9904BD95"),
//            Color.parseColor("#B204BD95"),
            Color.parseColor("#04BD95"),
//            Color.parseColor("#E604BD95"),

//            Color.parseColor("#3304BD95"),

    };
    private float startAngle_dian = 88;//起始滚动点bufen
    private float startAngle_scroll = 90;//起始滚动点bufen2
    ...
    public CountDownViewAll(Context context) {
        this(context, null);
    }

    public CountDownViewAll(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CountDownViewAll(Context context, AttributeSet attrs, int defStyleAttr) {
