...
public class DisplayUtils {
    ...
    public static int sp2px(Context ctx, int spValue) {
        final int scale = ctx.getResources().getDisplayMetrics().densityDpi;
        return spValue * scale;
    }
    ...
    public static int getAppInnerHeight(Activity mContext) {
        return DisplayUtils.SCREEN_HEIGHT - getStatusBarHeight(mContext) - DisplayUtils.dip2px(mContext, 48);
    }
