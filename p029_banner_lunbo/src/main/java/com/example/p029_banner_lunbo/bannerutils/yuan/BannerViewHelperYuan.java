 ...
 *
 */
public class BannerViewHelperYuan {
	private BannerViewYuan mBannerView;
	...
	public BannerViewHelperYuan(BannerViewYuan bannerView) {
		mBannerView = bannerView;
		mSwipeRefreshLayout = findSwipeRefreshLayout();
	}
	
	public BannerViewHelperYuan(BannerViewYuan bannerView, float accuracy) {
		this(bannerView);
		mAccuracy = accuracy;
	}
