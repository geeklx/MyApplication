 ...
 */
package com.example.shining.p041_uppicture.uploadimg.imgutils;
...
public class SpUtils {
    ...
    public static final String NATION = "geek_sp";
...
//    }
    ...
    public void registerOnSharedPreferenceChangeListener(SharedPreferences.OnSharedPreferenceChangeListener li) {
        mSp.registerOnSharedPreferenceChangeListener(li);
    }

    public void unregisterOnSharedPreferenceChangeListener(SharedPreferences.OnSharedPreferenceChangeListener li) {
        mSp.unregisterOnSharedPreferenceChangeListener(li);
    }
}
