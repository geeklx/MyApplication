...
public class UlPhotoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < UlBimp.bmp.size(); i++) {
            bmp.add(UlBimp.bmp.get(i));
        }
        for (int i = 0; i < UlBimp.drr.size(); i++) {
            drr.add(UlBimp.drr.get(i));
        }
        max = UlBimp.max;
        ...
        photo_bt_enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < del.size(); i++) {
                    UlFileUtils.delFile(del.get(i) + ".JPEG");
                }
                finish();
            }
        });
