...
public class UlImageBucketAdapter extends BaseAdapter {
	...
	UlBitmapCache cache;
	UlBitmapCache.ImageCallback callback = new UlBitmapCache.ImageCallback() {
		@Override
	...
	public UlImageBucketAdapter(Activity act, List<UlImageBucket> list) {
		this.act = act;
		dataList = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			holder = new Holder();
			arg1 = View.inflate(act, R.layout.activity_uploading_item_image_bucket, null);
		...
		UlImageBucket item = dataList.get(arg0);
