...
import com.github.geeklxbanner.transformer.CoverModeTransformer;
import com.github.geeklxbanner.transformer.ScaleYTransformer;
...
public class LXBannerView<T> extends RelativeLayout {
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link LXBannerView {@link #setPages(List, LXHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start() {
