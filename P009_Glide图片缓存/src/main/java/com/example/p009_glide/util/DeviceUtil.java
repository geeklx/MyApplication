...
public class DeviceUtil {
    ...
    public static float getRawSize(int unit, float value) {
        Resources res = Application.get().getResources();
    ...
    public static float sp2px(float spValue) {
        final float scale = Application.get().getResources().getDisplayMetrics().scaledDensity;
    ...
    public static float getDenstiy() {
        return Application.get().getResources().getDisplayMetrics().density;
    }
    ...
    public static String getVersionName() {
        try {
            PackageInfo pi = Application.get().getPackageManager().getPackageInfo(
                    Application.get().getPackageName(), 0);
