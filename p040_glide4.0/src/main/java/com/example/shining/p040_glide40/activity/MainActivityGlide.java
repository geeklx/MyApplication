...
import com.example.shining.p040_glide40.glide411.GlideImageLoader;
import com.example.shining.p040_glide40.glide411.GlideImageView;
import com.example.shining.p040_glide40.glide411.ShapeImageView;
import com.example.shining.p040_glide40.glide411.image.SingleImageActivity;
import com.example.shining.p040_glide40.glide411.progress.CircleProgressView;
import com.example.shining.p040_glide40.glide411.progress.OnGlideImageViewListener;
import com.example.shining.p040_glide40.glide411.progress.OnProgressListener;

import java.util.Random;

import static com.example.shining.p040_glide40.glide411.image.SingleImageActivity.KEY_IMAGE_URL;
import static com.example.shining.p040_glide40.glide411.image.SingleImageActivity.KEY_IMAGE_URL_THUMBNAIL;
...
public class MainActivityGlide extends AppCompatActivity {
    ...
    private void line41() {
        ...
        RequestOptions requestOptions = image41.requestOptions(R.drawable.ic_def_loading).centerCrop();
        if (isLoadAgain) {
    ...
    private void line42() {
        image42.setOnClickListener(v -> {
            ...
            intent.putExtra(KEY_IMAGE_URL_THUMBNAIL, image42SmallUrl);
            ActivityOptionsCompat compat = ActivityOptionsCompat
        ...
        imageLoader.setOnGlideImageViewListener(image42SmallUrl, (percent, isDone, exception) -> {
            if (exception != null && !TextUtils.isEmpty(exception.getMessage())) {
                Toast.makeText(getApplicationContext(), exception.getMessage(), Toast.LENGTH_LONG).show();
            }
