package com.example.p010_recycleviewall.tablayout.fragmentframelayout.fragment;
...
import com.example.p010_recycleviewall.tablayout.fragmentviewpager.RecycleViewAdapter1;
...
//        Bundle arg = getArguments();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (vRoot == null) {
            vRoot = LayoutInflater.from(mContext).inflate(R.layout.fragment_content, container, false);
        }
        findview();
        onclicklistener();
        initData();
    ...
    private void findview() {
        mTabLayout = (TabLayout) vRoot.findViewById(R.id.tl_shop_top);
