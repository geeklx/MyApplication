...
import com.example.p010_recycleviewall.domain.Coupon_listBeanNew;
import com.example.p010_recycleviewall.domain.PackageOneKeyBuyBeanNew;
import com.example.p010_recycleviewall.domain.TagBeanNew;
import com.example.p010_recycleviewall.widget.FlowLayout;
import com.example.p010_recycleviewall.widget.SimpleTagImageView;
...
public class RecycleAdapter1 extends RecyclerView.Adapter<RecycleAdapter1.ViewHolder> {
    ...
    public RecycleAdapter1(Context context) {
...
//                Pingjia ping = pingjia[i];
                ...
                tv1.setTextColor(context.getResources().getColor(R.color.white));//Color.parseColor("#FFFFFF")
                ...
                //context.getResources().getColor(R.color.orange_color)
                tv2.setTextColor(context.getResources().getColor(R.color.gray));//Color.parseColor("#FFFFFF")
        ...
        if (tags != null) {
            ...
            for (int i = 0; i < tags.size(); i++) {
                ...
                tvNav.setTag(false);
                tvNav.setTextColor(context.getResources().getColor(R.color.orange_color));//Color.parseColor("#FFFFFF")
