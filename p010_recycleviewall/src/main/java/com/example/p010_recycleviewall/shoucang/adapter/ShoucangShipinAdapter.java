...
public class ShoucangShipinAdapter extends RecyclerView.Adapter<ShoucangShipinAdapter.ViewHolder> {
    private LayoutInflater inflater;
    private Context context;
    private List<ShoucangShipinIndexModel> mratings;

    public ShoucangShipinAdapter(Context context) {
        this.context = context;
        inflater = LayoutInflater.from(context);
        mratings = new ArrayList<ShoucangShipinIndexModel>();
    }

    public void setContacts(List<ShoucangShipinIndexModel> ratings) {
        this.mratings = ratings;
    }

    public void addConstacts(List<ShoucangShipinIndexModel> ratings) {
        this.mratings.addAll(ratings);
    }

    public List<ShoucangShipinIndexModel> getMratings() {
        return mratings;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.activity_shoucang_shipin_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ShoucangShipinIndexModel ratings = mratings.get(position);
