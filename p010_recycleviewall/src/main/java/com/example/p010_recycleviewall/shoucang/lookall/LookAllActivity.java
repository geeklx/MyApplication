package com.example.p010_recycleviewall.shoucang.lookall;
...
import com.example.p010_recycleviewall.shoucang.adapter.ShoucangLookAllAdapter;
...
import com.example.p010_recycleviewall.shoucang.iview.ILookAllDeleteView;
import com.example.p010_recycleviewall.shoucang.iview.ILookAllView;
import com.example.p010_recycleviewall.shoucang.presenter.LookAllDeletePresenter;
import com.example.p010_recycleviewall.shoucang.presenter.LookAllPresenter;
import com.example.p010_recycleviewall.utils.ToastUtil;
import com.example.p010_recycleviewall.widget.emptyview.EmptyView;
...
public class LookAllActivity extends BaseActivity implements ILookAllView, ILookAllDeleteView, EmptyView.RetryListener, View.OnClickListener {
    ...
    @BindView(R.id.back)
    LinearLayout back;
    @BindView(R.id.rl_ceng1)
    RelativeLayout rl_ceng1;
    @BindView(R.id.ll_ceng2)
    ...
    protected int getLayoutId() {
        return R.layout.activity_shoucang_lookalldemo;
    }
    ...
    private void onclickListener() {
        ...
        if (mEmptyView.getmNodataLayout() != null) {
            TextView tv_notice_caipu = (TextView) mEmptyView.getmNodataLayout().findViewById(R.id.tv_notice_caipu);
    ...
    public void shezhi_quanxuan_gougou(int is_gou) {
        if (is_gou == 0) {
            Drawable drawable = getResources().getDrawable(R.drawable.foodmanager_choose1);
            drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
            tv_quanxuan.setCompoundDrawables(drawable, null, null, null);
        } else if (is_gou == 1) {
            Drawable drawable = getResources().getDrawable(R.drawable.foodmanager_choose2);
            drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
            tv_quanxuan.setCompoundDrawables(drawable, null, null, null);
        }
    }
    ...
    public void shezhi_quanxuan() {
        if (mAdapter.getAllListids() == null || mAdapter.getAllListids().size() == 0) {
            ...
            shezhi_tv_drawable(R.drawable.foodmanager_choose2, true);
        } else {
            ...
            if (mAdapter.getAllListids().size() == mAdapter.getMratings().size()) {
                ...
                shezhi_tv_drawable(R.drawable.foodmanager_choose1, false);
            } else {
