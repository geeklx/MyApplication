...
import com.example.p010_recycleviewall.shoucang.adapter.ShoucangShipinAdapter;
...
import com.example.p010_recycleviewall.shoucang.domain.ShoucangShipinIndexModel;
import com.example.p010_recycleviewall.shoucang.iview.IShipinView;
import com.example.p010_recycleviewall.shoucang.presenter.ShipinPresenter;
...
public class ShipinFragment extends BaseIndexNetFragment implements IShipinView, View.OnClickListener {
    ...
    private ShoucangShipinAdapter mAdapter;
    private List<ShoucangShipinIndexModel> list_data;

    private ShipinPresenter mShipinPresenter = new ShipinPresenter();
    ...
    protected void setup(View rootView, @Nullable Bundle savedInstanceState) {
        ...
        mContext = ShipinFragment.this.getActivity();
        findView(rootView);
        onclickListener();
        //
        doNetWork();
    ...
    private void doNetWork() {
        loadings();
        mShipinPresenter.onCreate(this);
        mShipinPresenter.getShipinPresenter();
    ...
    private void findView(View rootView) {
        ...
        //数据列表bufen
        mAdapter = new ShoucangShipinAdapter(mContext);
...
//        new GridLayoutManager(FoodManagerNewBanActivity.this, 3, LinearLayoutManager.HORIZONTAL, false)
        recycler_view1.setLayoutManager(new GridLayoutManager(mContext, 1, LinearLayoutManager.HORIZONTAL, false));
    ...
    private void onclickListener() {
        ...
        tv_notice_caipu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToastUtil.showToastCenter("发现更多视频 >");
            }
        });
    ...
    @Override
    public void onGetShipinSuccess(ShoucangShipinIndexBean data) {
        successes();
    ...
    @Override
    public void onGetShipinNotok(boolean isok) {
//        errorNets();
        nodatas();
    }

    @Override
    public void onGetShipinEmpty(String msg) {
        nodatas();
    }

    @Override
    public void onGetShipinFailed(String msg) {
        nodatas();
    }
}