...
import com.example.p010_recycleviewall.shoucang.domain.ShoucangDiantaiIndexModel;
...
public class ShoucangDiantaiAdapter extends RecyclerView.Adapter<ShoucangDiantaiAdapter.ViewHolder> {
    private LayoutInflater inflater;
    private Context context;
    private List<ShoucangDiantaiIndexModel> mratings;

    public ShoucangDiantaiAdapter(Context context) {
        this.context = context;
        inflater = LayoutInflater.from(context);
        mratings = new ArrayList<ShoucangDiantaiIndexModel>();
    }

    public void setContacts(List<ShoucangDiantaiIndexModel> ratings) {
        this.mratings = ratings;
    }

    public void addConstacts(List<ShoucangDiantaiIndexModel> ratings) {
        this.mratings.addAll(ratings);
    }

    public List<ShoucangDiantaiIndexModel> getMratings() {
        return mratings;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.activity_shoucang_diantai_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ShoucangDiantaiIndexModel ratings = mratings.get(position);
