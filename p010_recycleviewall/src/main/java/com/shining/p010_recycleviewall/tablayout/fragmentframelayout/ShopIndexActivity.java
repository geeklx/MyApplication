...
import com.shining.p010_recycleviewall.tablayout.fragmentframelayout.fragment.FragmentContent;
import com.shining.p010_recycleviewall.tablayout.fragmentframelayout.fragment.FragmentIndex;
import com.shining.p010_recycleviewall.tablayout.fragmentframelayout.presenter.ShopCategoryPresenter;
...
public class ShopIndexActivity extends BaseViewActivity implements IShopCategoryView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(com.shining.p010_recycleviewall.R.layout.activity_tablayout_fragmentframelayout);
    ...
    private void showFragment(String tag) {
        ...
        if (tag.equalsIgnoreCase(ShopCategoryItem.DEF_TAG_ID)) { // 推荐fragment
            if (mShopIndexFragment == null) {
                ...
                transaction.add(com.shining.p010_recycleviewall.R.id.container, mShopIndexFragment, INDEX_TAG);
            } else {
            ...
            if (mShopGoodsListFragment == null) {
                ...
                transaction.add(com.shining.p010_recycleviewall.R.id.container, mShopGoodsListFragment, LIST_TAG);
            } else {
