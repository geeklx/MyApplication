...
import com.shining.p010_recycleviewall.widget.NoScrollView.NoScrollViewPager;
...
public class MainActivityTabLayout extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.shining.p010_recycleviewall.R.layout.activity_tablayout_fragmentviewpager);
        findview();
        onclicklistener();
        doNetWork();
    }
    ...
    private void doNetWork() {
        ...
        tablayout.setTabTextColors(getResources().getColor(com.shining.p010_recycleviewall.R.color.black_title), Color.WHITE);
        tablayout.setSelectedTabIndicatorColor(getResources().getColor(com.shining.p010_recycleviewall.R.color.tab_bg));
    }
    ...
    private void findview() {
        viewPager = (NoScrollViewPager) findViewById(com.shining.p010_recycleviewall.R.id.vp_fm);
        tablayout = (TabLayout) findViewById(com.shining.p010_recycleviewall.R.id.tl_fm);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case com.shining.p010_recycleviewall.R.id.tl_fm:
