package com.shining.p010_recycleviewall.recycleviewlistview;
...
import com.shining.p010_recycleviewall.domain.LabThree;
import com.shining.p010_recycleviewall.domain.LabTwo;
...
public class MainActivity1 extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.shining.p010_recycleviewall.R.layout.activity_main_recyclelistview);
        findView();
        addlisteners();
        DataFirst();
    }
...
//                    ToastUtil.showToastLong(result.getMessage());
    ...
    private void findView() {
        refresh();
        recyclerView = (RecyclerView) findViewById(com.shining.p010_recycleviewall.R.id.recycler_view1);
        createAdapter();
        which_page = 1;
...
//                Toast.makeText(MainActivity2.this, "刷新了请求数据", Toast.LENGTH_LONG).show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.shining.p010_recycleviewall.R.id.recycler_view1:
                //点击bufen
    ...
    private void refresh() {
        mSwipeLayout = (SwipeRefreshLayout) findViewById(com.shining.p010_recycleviewall.R.id.refresh);
        mSwipeLayout.setOnRefreshListener(this);
        mSwipeLayout.setColorSchemeColors(getResources().getIntArray(com.shining.p010_recycleviewall.R.array.swipeRefreshColors));
