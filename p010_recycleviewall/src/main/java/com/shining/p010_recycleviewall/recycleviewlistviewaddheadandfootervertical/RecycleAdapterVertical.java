...
public class RecycleAdapterVertical extends RecyclerView.Adapter<RecycleAdapterVertical.ViewHolder> {
    ...
    public RecycleAdapterVertical(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.activity_recycleview_vertical_item, parent, false);
