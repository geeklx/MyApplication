package com.shining.p010_recycleviewall.bluetooth;
...
public class RecycleAdapterbluetooth1 extends RecyclerView.Adapter<RecycleAdapterbluetooth1.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(com.shining.p010_recycleviewall.R.layout.activity_main_recyclelistview_bluetooth_item, parent, false);
        ViewHolder viewHolder = new ViewHolder(view);
        viewHolder.tv_content_tag1 = (TextView) view.findViewById(com.shining.p010_recycleviewall.R.id.tv_content_tag1);
        viewHolder.tv_content_tag2 = (TextView) view.findViewById(com.shining.p010_recycleviewall.R.id.tv_content_tag2);
        viewHolder.tv_content_tag3 = (TextView) view.findViewById(com.shining.p010_recycleviewall.R.id.tv_content_tag3);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (ratings.getDevice().getType() == 1) {
            viewHolder.tv_content_tag1.setBackgroundResource(com.shining.p010_recycleviewall.R.drawable.lanya_icon1);
        } else if (ratings.getDevice().getType() == 2) {
            viewHolder.tv_content_tag1.setBackgroundResource(com.shining.p010_recycleviewall.R.drawable.lanya_icon2);
        } else if (ratings.getDevice().getType() == 3) {
            viewHolder.tv_content_tag1.setBackgroundResource(com.shining.p010_recycleviewall.R.drawable.lanya_icon3);
        }
//        viewHolder.tv_content_tag1.setText("图标：" + ratings.getDevice().getType());
        if (ratings.getStatus().equals(context.getResources().getString(com.shining.p010_recycleviewall.R.string.bluetooth_tips5))) {
            viewHolder.tv_content_tag2.setTextColor(ContextCompat.getColor(context, com.shining.p010_recycleviewall.R.color.red2));
            viewHolder.tv_content_tag3.setTextColor(ContextCompat.getColor(context, com.shining.p010_recycleviewall.R.color.red2));
        } else {
            viewHolder.tv_content_tag2.setTextColor(ContextCompat.getColor(context, com.shining.p010_recycleviewall.R.color.black_common));
            viewHolder.tv_content_tag3.setTextColor(ContextCompat.getColor(context, com.shining.p010_recycleviewall.R.color.black_common));
        }
