...
public class ShapeLoadingView extends View {
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(com.shining.p010_recycleviewall.R.color.triangle));
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        setBackgroundColor(getResources().getColor(com.shining.p010_recycleviewall.R.color.view_bg));
          mTriangleColor = getResources().getColor(com.shining.p010_recycleviewall.R.color.triangle);
          mCircleColor = getResources().getColor(com.shining.p010_recycleviewall.R.color.circle);
          mRectColor = getResources().getColor(com.shining.p010_recycleviewall.R.color.triangle);
    }
        ...
        switch (mShape) {
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(com.shining.p010_recycleviewall.R.color.circle));
                    Path path = new Path();
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(com.shining.p010_recycleviewall.R.color.rect));
