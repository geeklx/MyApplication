...
public class LoadingView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context
                .obtainStyledAttributes(attrs, com.shining.p010_recycleviewall.R.styleable.LoadingView);
        mLoadText = typedArray.getString(com.shining.p010_recycleviewall.R.styleable.LoadingView_loadingText);
        mTextAppearance = typedArray.getResourceId(com.shining.p010_recycleviewall.R.styleable.LoadingView_loadingTextAppearance, -1);
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(com.shining.p010_recycleviewall.R.layout.load_view, null);
        ...
        mShapeLoadingView = (ShapeLoadingView) view.findViewById(com.shining.p010_recycleviewall.R.id.shapeLoadingView);

        mIndicationIm = (ImageView) view.findViewById(com.shining.p010_recycleviewall.R.id.indication);
        mLoadTextView = (TextView) view.findViewById(com.shining.p010_recycleviewall.R.id.promptTV);
