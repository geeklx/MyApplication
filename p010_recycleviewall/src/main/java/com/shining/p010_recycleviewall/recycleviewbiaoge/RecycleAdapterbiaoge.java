...
public class RecycleAdapterbiaoge extends RecyclerView.Adapter<RecycleAdapterbiaoge.ViewHolder> {
    private LayoutInflater inflater;
    private Context context;
    private List<Biaoge_listBean> mratings;

    public RecycleAdapterbiaoge(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(com.shining.p010_recycleviewall.R.layout.recycleviewbiaoge_list_item, parent, false);
